...
make clean all PLATFORM=WEZEN FUNC=WLAN LOW_POWER=0 HOST_CFG80211=Y INLINE_MODE=N RF=C0 CONFIG=72 FW_LOAD=NONE BUS_IF=PCIE SECURE_DOMAIN=Y INLINE_RX=Y
