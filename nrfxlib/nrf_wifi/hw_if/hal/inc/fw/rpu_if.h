...
#define RPU_ADDR_FPGA_REGS_REGION 0x8000000
...
#define RPU_ADDR_GRTC_REGION 0x400E0000
...
#define RPU_BELLBOARD_GRTC_ADDR_MASK_OFFSET 0x0000FFFF
#else
...
#ifdef SOC_WEZEN
#define RPU_REG_BIT_RAM_ACCESS 0
#define RPU_REG_BIT_ROM_ACCESS 1
...
#define WEZEN_RPU_REG_INT_TO_WIFICORE_BELLBOARD_TASKS_TRIGGER    0x40074000
#else
...
#endif
//#define RPU_PKTRAM_SIZE (RPU_ADDR_PKTRAM_END - RPU_MEM_PKT_BASE)
