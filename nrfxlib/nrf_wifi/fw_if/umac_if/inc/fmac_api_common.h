...
#else
/**
 * nrf_wifi_fmac_fw_chk_boot() - Checks that the RPU WLAN firmware has booted up properly.
 ...
 *            callback function.
 *
 * This function checks that the FullMAC firmwares have booted up properly in the
 * RPU WLAN device.
 *
 * Returns: Status
